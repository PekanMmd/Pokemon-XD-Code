...
let animationTypesStruct = GoDStruct(name: "Model Animation Types", format: [
	.byte(name: "Idle 1", description: "", type: .uint),
	...
	.byte(name: "Idle 2", description: "", type: .uint),
	.byte(name: "Idle 3", description: "", type: .uint),
	.byte(name: "Idle 4", description: "", type: .uint),
	.byte(name: "Idle 5", description: "", type: .uint),
	.byte(name: "Idle 6", description: "", type: .uint),
