...
class GoDNetworkingManager {
	...
	static func get<T: Codable>(_ url: String, json: Codable? = nil, completion: ((T?) -> Void)?) {
		request(method: .GET, urlString: url, json: nil, completion: completion)
	}

	static func post(_ url: String, json: Codable) {
		request(method: .POST, urlString: url, json: json)
	}

	static func post<T: Codable>(_ url: String, json: Codable, completion: ((T?) -> Void)?) {
		request(method: .POST, urlString: url, json: json, completion: completion)
	}

	private static func request(method: HTTPMethods, urlString: String, json: Codable?) {
	...
	private static func request<T: Codable>(method: HTTPMethods, urlString: String, json: Codable?, completion: ((T?) -> Void)?) {
