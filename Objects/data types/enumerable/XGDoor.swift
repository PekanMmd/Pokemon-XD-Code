...
extension XGDoor: XGEnumerable {
	var enumerableName: String {
		return "Door " + String(format: "%03d", index)
	}
	...
	static var allValues: [XGDoor] {
		var values = [XGDoor]()
		for i in 0 ..< CommonIndexes.NumberOfDoors.value {
			values.append(XGDoor(index: i))
		}
		return values
	}
}
