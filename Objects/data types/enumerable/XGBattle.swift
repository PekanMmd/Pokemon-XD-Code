...
final class XGBattle: NSObject, Codable {
	...
	var title : String {
		...
		let p2t = p2Trainer
		let p2 = p2t == nil ? (p2TID == 0x1388 ? "Player" : "Invalid") : p2t!.name.string
		
		let p3t = p3Trainer
		let p3 = p3t == nil ? (p3TID == 0x1388 ? "Player" : "Invalid") : p3t!.name.string
		
		let p4t = p4Trainer
		let p4 = p4t == nil ? (p4TID == 0x1388 ? "Player" : "Invalid") : p4t!.name.string
