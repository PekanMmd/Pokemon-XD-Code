...
mklink "spm\virt\GoD-CLI\Sources\GoDToolCLExtensions.swift" "%cd%\extensions\GoDToolCLExtensions.swift" > NUL
...
mklink "spm\virt\GoD-CLI\Sources\XGExtensions.swift" "%cd%\extensions\XGExtensions.swift" > NUL
...
mklink "spm\virt\GoD-CLI\Sources\XGOSXExtensions.swift" "%cd%\extensions\XGOSXExtensions.swift" > NUL
...
mklink "spm\virt\GoD-CLI\Sources\XGDolPatcher.swift" "%cd%\Objects\managers\XGDolPatcher.swift" > NUL
...
mklink "spm\virt\GoD-CLI\Sources\EnumerableDocumentable.swift" "%cd%\protocols\EnumerableDocumentable.swift" > NUL
...
mklink "spm\virt\GoD-CLI\Sources\XGStoryProgress.swift" "%cd%\Objects\data types\enumerable\XGStoryProgress.swift" > NUL
...
mklink "spm\virt\GoD-CLI\Sources\XDSExtensions.swift" "%cd%\extensions\XDSExtensions.swift" > NUL
...
mklink "spm\virt\GoD-CLI\Sources\GoDOSXExtensions.swift" "%cd%\extensions\GoDOSXExtensions.swift" > NUL
...
mklink "spm\virt\Colosseum-CLI\Sources\CMFiles.swift" "%cd%\enums\CMFiles.swift" > NUL
...
mklink "spm\virt\Colosseum-CLI\Sources\CMOSXExtensions.swift" "%cd%\extensions\CMOSXExtensions.swift" > NUL
...
mklink "spm\virt\Colosseum-CLI\Sources\XGDolPatcher.swift" "%cd%\Objects\managers\XGDolPatcher.swift" > NUL
mklink "spm\virt\Colosseum-CLI\Sources\XGFontColours.swift" "%cd%\enums\XGFontColours.swift" > NUL
mklink "spm\virt\Colosseum-CLI\Sources\ColosseumToolCLExtensions.swift" "%cd%\extensions\ColosseumToolCLExtensions.swift" > NUL
...
mklink "spm\virt\Colosseum-CLI\Sources\CMColosseumRounds.swift" "%cd%\enums\CMColosseumRounds.swift" > NUL
...
mklink "spm\virt\Colosseum-CLI\Sources\GoDOSXExtensions.swift" "%cd%\extensions\GoDOSXExtensions.swift" > NUL
...
mklink "spm\virt\Colosseum-CLI\Sources\XGExtensions.swift" "%cd%\extensions\XGExtensions.swift" > NUL
mklink "spm\virt\Colosseum-CLI\Sources\CMRandomiser.swift" "%cd%\Objects\managers\CMRandomiser.swift" > NUL
...
mklink "spm\virt\Colosseum-CLI\Sources\main.swift" "%cd%\Colosseum-CLI\main.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRDataTableEntry.swift" "%cd%\Revolution Tool CL\objects\PBRDataTableEntry.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRScriptOps.swift" "%cd%\Revolution Tool CL\enums\PBRScriptOps.swift" > NUL
mklink "spm\virt\PBR-CLI\Sources\PBRMoveCategory.swift" "%cd%\Revolution Tool CL\enums\PBRMoveCategory.swift" > NUL
mklink "spm\virt\PBR-CLI\Sources\PBRDecks.swift" "%cd%\Revolution Tool CL\enums\PBRDecks.swift" > NUL
mklink "spm\virt\PBR-CLI\Sources\XGNatures.swift" "%cd%\enums\XGNatures.swift" > NUL
mklink "spm\virt\PBR-CLI\Sources\PBRFiles.swift" "%cd%\Revolution Tool CL\enums\PBRFiles.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRISO.swift" "%cd%\Revolution Tool CL\objects\PBRISO.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRContestAppeals.swift" "%cd%\Revolution Tool CL\enums\PBRContestAppeals.swift" > NUL
mklink "spm\virt\PBR-CLI\Sources\XGExtensions.swift" "%cd%\extensions\XGExtensions.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRCLExtensions.swift" "%cd%\extensions\PBRCLExtensions.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRDolPatcher.swift" "%cd%\Revolution Tool CL\objects\PBRDolPatcher.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRDeckTrainer.swift" "%cd%\Revolution Tool CL\enums\PBRDeckTrainer.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\EnumerableDocumentable.swift" "%cd%\protocols\EnumerableDocumentable.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRDeckPokemon.swift" "%cd%\Revolution Tool CL\enums\PBRDeckPokemon.swift" > NUL
mklink "spm\virt\PBR-CLI\Sources\PBRItem.swift" "%cd%\Revolution Tool CL\objects\PBRItem.swift" > NUL
mklink "spm\virt\PBR-CLI\Sources\PBRConstant.swift" "%cd%\Revolution Tool CL\objects\PBRConstant.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\main.swift" "%cd%\PBR-CLI\main.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\GoDOSXExtensions.swift" "%cd%\extensions\GoDOSXExtensions.swift" > NUL
...
mklink "spm\virt\PBR-CLI\Sources\PBRDataTable.swift" "%cd%\Revolution Tool CL\objects\PBRDataTable.swift" > NUL
