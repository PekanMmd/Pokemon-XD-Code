...
enum XGFileTypes: Int, Codable, CaseIterable {
	...
	var info: String? {
		...
		case .raw : return "This file format has a lot of different uses in other contexts. It is commonly used as the format for save file data that has been extracted from `.gci` save files or memory card data. It is also the format used for encrypted ereader card data."
