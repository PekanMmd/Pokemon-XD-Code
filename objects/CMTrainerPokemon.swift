	...
	var dictionaryRepresentation : [String : AnyObject] {
		get {
			...
			if self.isShadow {
				...
				dictRep["shadowID"] = self.shadowID as AnyObject?
				dictRep["shadowFirstTID"] = self.shadowFirstTID as AnyObject?
			...
			dictRep["pokeball"] = self.pokeball.dictionaryRepresentation as AnyObject?
	...
	var readableDictionaryRepresentation : [String : AnyObject] {
		get {
			...
			if self.isShadow {
				...
				shadowData["shadowID"] = self.shadowID as AnyObject?
				shadowData["shadowCounter"] = self.shadowCounter as AnyObject?
				shadowData["shadowFirstTID"] = self.shadowFirstTID as AnyObject?
				dictRep["shadowData"] = shadowData as AnyObject?
			}
			
			dictRep["item"] = self.item.name.string as AnyObject?
			dictRep["pokeball"] = self.pokeball.name.string as AnyObject?
