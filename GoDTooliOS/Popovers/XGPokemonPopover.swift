...
class XGPokemonPopover: XGPopover, UISearchResultsUpdating, UISearchBarDelegate {
	...
	override init() {
		...
		for i in 0 ..< kNumberOfPokemon {
			...
			pokes.append( (mon.name.string,typeNames[mon.type1.rawValue],typeNames[mon.type2.rawValue],i))
		}
