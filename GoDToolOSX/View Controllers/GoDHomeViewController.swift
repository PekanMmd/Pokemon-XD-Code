...
let xdtools = ["Trainer Editor","Shadow Pokemon Editor","Pokemon Stats Editor","Move Editor","Item Editor","Pokespot Editor","Gift Pokemon Editor", "Type Editor", "Treasure Editor", "Patches", "Randomizer", "Message Editor", "Script Compiler", "Collision Viewer", "Interaction Editor", "Vertex Filters", "Table Editor", "ISO Explorer"]
...
let colotools = ["Trainer Editor","Pokemon Stats Editor","Move Editor","Item Editor","Gift Pokemon Editor", "Type Editor", "Treasure Editor", "Patches", "Randomizer", "Message Editor", "Collision Viewer", "Interaction Editor", "Vertex Filters", "Table Editor", "ISO Explorer"]
...
let pbrtools = ["Pokemon Stats Editor", "Move Editor", "Type Editor", "Message Editor", "Randomizer", "Patches", "Table Editor", "ISO Explorer"]
